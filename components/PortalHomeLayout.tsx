...
function PortalHomeLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const masterSubTabs = [
    ...
    { name: 'Beat Status', href: '/city/beat-status', icon: <CheckCircle2 size={15} />, isActive: pathname.startsWith('/city/beat-status') },
    { name: 'Beat Requests', href: '/city/beat-requests', icon: <FileText size={15} />, isActive: pathname.startsWith('/city/beat-requests') },
  ];
