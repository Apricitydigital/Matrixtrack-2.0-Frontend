            ...
            {authMode === "login" ? (
              ...
              <div>
                ...
                <form onSubmit={handleRegisterSubmit}>
                  <div className="mt-field">
                    <label className="mt-field-label"><Hash size={14} /> ULB Code</label>
                    <input
                      type="text"
                  ...
                  <div className="mt-field">
                    <label className="mt-field-label"><ShieldCheck size={14} /> Requested Role</label>
                    <select
                      className="mt-input"
                      value={requestedRole}
                      onChange={(e) =>
                        setRequestedRole(e.target.value as UnifiedRegistrationRole)
                      }
                      required
                    >
                  ...
                  <div className="mt-field">
                    ...
                    <div className="mt-portal-grid">
                      {[
                        { key: "TASKFORCE_20", title: "Taskforce 20" },
                        { key: "MATRIX_TRACK", title: "MatrixTrack" },
                        { key: "WARD_RANKING", title: "Ward Ranking" },
                      ].map((portal) => {
                  ...
                  <div className="mt-field">
                    <label className="mt-field-label"><Phone size={14} /> Phone Number</label>
                    <input
                      type="tel"
                  ...
                  <div className="mt-field">
                    <label className="mt-field-label"><Hash size={14} /> Aadhar Number</label>
                    <input
                      type="text"
