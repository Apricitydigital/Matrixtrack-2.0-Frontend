...
export default function CityModulesPage() {
    ...
    return (
        <RoleGuard roles={["CITY_ADMIN", "HMS_SUPER_ADMIN", "COMMISSIONER", "ULB_OFFICER"]}>
            <div className="page" style={{ padding: "0px", minHeight: "auto" }}>
                <div style={{ maxWidth: "1200px", margin: "0 auto" }}>

                    {error && (
                        <div style={{ padding: "14px 18px", backgroundColor: "#fef2f2", border: "1px solid #fee2e2", borderRadius: "12px", color: "#991b1b", marginBottom: "20px", display: "flex", alignItems: "center", gap: "10px", fontSize: "0.875rem" }}>
                            <XCircle size={18} />
                    ...
                    <div style={{ marginBottom: "24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <div>
                            ...
                            <p style={{ fontSize: "0.8125rem", color: "#64748b", margin: "4px 0 0", fontWeight: 500 }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                            <div style={{ display: "flex", gap: "8px" }}>
                                ...
                                <div style={{ backgroundColor: "#eff6ff", padding: "6px 12px", borderRadius: "8px", border: "1px solid #bfdbfe", textAlign: "center" }}>
                                    <div style={{ fontSize: "0.8125rem", fontWeight: 800, color: "#2563eb" }}>{loading ? "..." : modules.length} Total</div>
                                </div>
                            </div>
                            <button
                    ...
                    <div style={{ marginBottom: "16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <h2 style={{ fontSize: "0.875rem", fontWeight: 800, color: "#475569", margin: 0, textTransform: "uppercase", letterSpacing: "0.5px" }}>
                            {searchQuery ? `Search Results (${filteredModules.length})` : "Taskforce Core Registry"}
                        </h2>
                    </div>
                    ...
                    <div style={{
                        ...
                        {loading ? (
                            Array(4).fill(0).map((_, i) => (
                                <div key={i} className="skeleton" style={{ height: "180px", borderRadius: "20px", flex: "1 1 300px", maxWidth: "420px" }} />
                            ))
                        ) : filteredModules.length === 0 ? (
                            <div style={{ width: "100%", padding: "60px 24px", textAlign: "center", backgroundColor: "white", borderRadius: "20px", border: "1px dashed #e2e8f0" }}>
                                <div style={{ backgroundColor: "#f8fafc", width: "60px", height: "60px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
                                    <Database size={28} color="#cbd5e1" />
                                </div>
                                <h3 style={{ fontSize: "1.125rem", fontWeight: 800, color: "#1e293b", margin: "0 0 4px" }}>No Taskforce Modules Found</h3>
                                <p style={{ color: "#64748b", fontSize: "0.875rem" }}>Adjust search terms or check city assignment.</p>
                            </div>
                        ) : (
