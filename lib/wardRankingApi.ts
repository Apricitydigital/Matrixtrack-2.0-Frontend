...
export type WardRankingQuery = {
  ...
  /**
   * Marks an intentional full-history Ward Ranking request.
   * Long ranges generated by the All filter also set this automatically.
   */
  allDates?: boolean;
...
export type WardRankingDateBoundsResponse = {
  from: string;
  to: string;
  source: 'OPERATIONAL_HISTORY' | 'SNAPSHOT_HISTORY' | 'FALLBACK_366_DAYS';
};

export const WardRankingApi = {
  dateBounds: () =>
    apiFetch<WardRankingDateBoundsResponse>(
      '/ward-ranking/date-bounds'
    ),
